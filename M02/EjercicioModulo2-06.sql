...
SELECT DISTINCT i.idInstructor, i.nombre, i.apellido FROM instructor i JOIN cohorte c ON (c.idInstructor = i.idInstructor) JOIN carrera ca ON (c.idCarrera = ca.idCarrera) WHERE ca.nombre = 'Full Stack Developer';
...
-- #9
SELECT a.nombre, a.apellido, a.fechaNacimiento, ca.nombre AS nombre_carrera FROM alumno a 
